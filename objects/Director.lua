...
function Director:new(stage)
   -- Director.super.new(self, area, x, y, opts)
    ...
    self.difficulty = 1
    self.round_circle = 22 
    self.round_time = 0
    self.enemy_to_porint = {
        Rock[1] = 1
        Shooter[0] = 2
    }
    ...
    self.difficulty_to_points = {}
    self.difficulty_to_points[1] = 16
    for i in 2, 1024, 4 do
        self.difficulty_to_points[i] = self.difficulty_to_points[i-1]+8
        self.difficulty_to_points[i + 1] = self.difficulty_to_points[i]
        self.difficulty_to_points[i + 2] = math.floor(self.difficulty_to_points[i+1]/1.5)
        self.difficulty_to_points[i + 3] = math.floor(2*self.difficulty_to_points[i+2])
    end
end
...
function Director:update(dt)
    ...
    if self.round_time == self.round_circle then
        self.round_time = 0
        self.difficulty = self.difficulty + 1
        self:setEnemySpawnForRound(difficulty)
    end
